  ...
  (cond
    ...
    ((listp intent)
     (list :category (getf intent :category)
           :primary-intent (getf intent :primary-intent)
           :secondary-intents (copy-list (or (getf intent :secondary-intents) '()))
           :task-archetype (getf intent :task-archetype)
           :requested-deliverable (getf intent :requested-deliverable)
           :phase-intent (getf intent :phase-intent)
