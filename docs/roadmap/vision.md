...
layout: default
title: Vision
hero_title: The System Is Not an IDE
hero_text: sbcl-agent should be understood as a persistent symbolic environment rather than as a shell with more features or a conventional IDE in Lisp.
eyebrow: Vision
permalink: /roadmap/vision.html
description: Positioning statement for the next stage of the SBCL agent project.
---
