...
- a governed execution environment with a shared execution substrate, actor-owned governance, workflow continuity, and desktop-host layers already in place
